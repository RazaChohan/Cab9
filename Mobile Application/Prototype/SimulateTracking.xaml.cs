...
namespace Prototype
{
    public partial class SimulateTracking : PhoneApplicationPage
    {
        ...
        private async void Locate_Click()
        {
            ...
            Writer.WriteLine(gPos.Coordinate.Latitude.ToString("0.000000"));
            Writer.WriteLine(gPos.Coordinate.Longitude.ToString("0.000000"));
            Writer.Close();
