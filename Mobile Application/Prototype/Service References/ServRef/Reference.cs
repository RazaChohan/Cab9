...
namespace Prototype.ServRef {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServRef.IService")]
    public interface IService {
        ...
        System.IAsyncResult BeginGetDataUsingDataContract(Prototype.ServRef.CompositeType composite, System.AsyncCallback callback, object asyncState);
        
        Prototype.ServRef.CompositeType EndGetDataUsingDataContract(System.IAsyncResult result);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChannel : Prototype.ServRef.IService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class GetDataUsingDataContractCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Prototype.ServRef.CompositeType Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Prototype.ServRef.CompositeType)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceClient : System.ServiceModel.ClientBase<Prototype.ServRef.IService>, Prototype.ServRef.IService {
        ...
        System.IAsyncResult Prototype.ServRef.IService.BeginGetData(int value, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetData(value, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string Prototype.ServRef.IService.EndGetData(System.IAsyncResult result) {
            return base.Channel.EndGetData(result);
        }
        
        private System.IAsyncResult OnBeginGetData(object[] inValues, System.AsyncCallback callback, object asyncState) {
            int value = ((int)(inValues[0]));
            return ((Prototype.ServRef.IService)(this)).BeginGetData(value, callback, asyncState);
        }
        
        private object[] OnEndGetData(System.IAsyncResult result) {
            string retVal = ((Prototype.ServRef.IService)(this)).EndGetData(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Prototype.ServRef.IService.BeginGetDataUsingDataContract(Prototype.ServRef.CompositeType composite, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetDataUsingDataContract(composite, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Prototype.ServRef.CompositeType Prototype.ServRef.IService.EndGetDataUsingDataContract(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetDataUsingDataContract(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Prototype.ServRef.CompositeType composite = ((Prototype.ServRef.CompositeType)(inValues[0]));
            return ((Prototype.ServRef.IService)(this)).BeginGetDataUsingDataContract(composite, callback, asyncState);
        }
        
        private object[] OnEndGetDataUsingDataContract(System.IAsyncResult result) {
            Prototype.ServRef.CompositeType retVal = ((Prototype.ServRef.IService)(this)).EndGetDataUsingDataContract(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetDataUsingDataContractAsync(Prototype.ServRef.CompositeType composite) {
            this.GetDataUsingDataContractAsync(composite, null);
        }
        
        public void GetDataUsingDataContractAsync(Prototype.ServRef.CompositeType composite, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Prototype.ServRef.IService.BeginCalculateRoadDistance(string Origin, string Destination, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginCalculateRoadDistance(Origin, Destination, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        double Prototype.ServRef.IService.EndCalculateRoadDistance(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginCalculateRoadDistance(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Prototype.ServRef.IService)(this)).BeginCalculateRoadDistance(Origin, Destination, callback, asyncState);
        }
        
        private object[] OnEndCalculateRoadDistance(System.IAsyncResult result) {
            double retVal = ((Prototype.ServRef.IService)(this)).EndCalculateRoadDistance(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Prototype.ServRef.IService.BeginCabBooking(string BookingStatus, System.DateTime BookingDateTime, string BookingOrigin, string BookingDestination, string BookingCabType, System.AsyncCallback callback, object asyncState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string Prototype.ServRef.IService.EndCabBooking(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginCabBooking(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Prototype.ServRef.IService)(this)).BeginCabBooking(BookingStatus, BookingDateTime, BookingOrigin, BookingDestination, BookingCabType, callback, asyncState);
        }
        
        private object[] OnEndCabBooking(System.IAsyncResult result) {
            string retVal = ((Prototype.ServRef.IService)(this)).EndCabBooking(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Prototype.ServRef.IService.BeginAuthenticateCustomer(string username, string password, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginAuthenticateCustomer(username, password, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string Prototype.ServRef.IService.EndAuthenticateCustomer(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAuthenticateCustomer(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Prototype.ServRef.IService)(this)).BeginAuthenticateCustomer(username, password, callback, asyncState);
        }
        
        private object[] OnEndAuthenticateCustomer(System.IAsyncResult result) {
            string retVal = ((Prototype.ServRef.IService)(this)).EndAuthenticateCustomer(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Prototype.ServRef.IService.BeginAuthenticateDriver(string username, string password, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginAuthenticateDriver(username, password, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string Prototype.ServRef.IService.EndAuthenticateDriver(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAuthenticateDriver(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string username = ((string)(inValues[0]));
            string password = ((string)(inValues[1]));
            return ((Prototype.ServRef.IService)(this)).BeginAuthenticateDriver(username, password, callback, asyncState);
        }
        
        private object[] OnEndAuthenticateDriver(System.IAsyncResult result) {
            string retVal = ((Prototype.ServRef.IService)(this)).EndAuthenticateDriver(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override Prototype.ServRef.IService CreateChannel() {
            return new ServiceClientChannel(this);
        }
        
        private class ServiceClientChannel : ChannelBase<Prototype.ServRef.IService>, Prototype.ServRef.IService {
            
            public ServiceClientChannel(System.ServiceModel.ClientBase<Prototype.ServRef.IService> client) : 
                    base(client) {
            }
            ...
            public System.IAsyncResult BeginGetDataUsingDataContract(Prototype.ServRef.CompositeType composite, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = composite;
            ...
            public Prototype.ServRef.CompositeType EndGetDataUsingDataContract(System.IAsyncResult result) {
                object[] _args = new object[0];
                Prototype.ServRef.CompositeType _result = ((Prototype.ServRef.CompositeType)(base.EndInvoke("GetDataUsingDataContract", _args, result)));
                return _result;
            }
